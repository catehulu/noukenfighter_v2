...
@section('content')
	...
	<div class="language">
		<div class="container">
			<div class="row">
				<div class="col">
					<div class="language_title">Learn Japanese Easily</div>
				</div>
			</div>
			<div class="row">
				<div class="col">
				...
				<div class="col-lg-4 course_col">
					<div class="course">
						...
						<div class="course_body">
							<div class="course_title"><a href="course.html">Kanji</a></div>
						...
						<div class="course_footer d-flex align-items-center justify-content-start">
							<div class="row">
								<div class="col-sm-6 d-flex-row">
										<a href="/course" class="btn btn-primary">Free</a>
									</div>
								<div class="col-sm-6 flex-row-reverse">
										<a href="/subscribe" class="btn btn-info">Premium</a>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="course">
						...
						<div class="course_footer d-flex align-items-center justify-content-start">
							<div class="row">
								...
								<div class="col-sm-6 flex-row-reverse">
										<a href="/course" class="btn btn-info">Premium</a>
								</div>
							</div>
						</div>
					</div>
