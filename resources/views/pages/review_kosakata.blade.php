            ...
            <div class="mainPart" style="margin-bottom: 50px;">
                ...
                <div class="row justify-content-center align-items-center p-5">
                    <div class="col-5 bg-blue completeRoundedSquare m-3 hoverEffect">
                        <div class="d-flex align-items-center justify-content-center h-100">
                            <form class="text-center" action="#">
                                <button type="submit" class="btn text-white" style="font-size: 50px;">ENG_VOCAB 1</button>
                            </form>
                        </div>
                    </div>
                    ...
                    <div class="col-5 bg-blue completeRoundedSquare m-3 hoverEffect">
                        <div class="d-flex align-items-center justify-content-center h-100">
                            <form class="text-center" action="#">
                                <button type="submit" class="btn text-white" style="font-size: 50px;">ENG_VOCAB 2</button>
                            </form>
                        </div>
                    </div>
                    ...
                    <div class="col-5 bg-blue completeRoundedSquare m-3 hoverEffect">
                        <div class="d-flex align-items-center justify-content-center h-100">
                            <form class="text-center" action="#">
                                <button type="submit" class="btn text-white" style="font-size: 50px;">ENG_VOCAB 3</button>
                            </form>
                        </div>
                    </div>
                    ...
                    <div class="col-5 bg-blue completeRoundedSquare m-3 hoverEffect">
                        <div class="d-flex align-items-center justify-content-center h-100">
                            <form class="text-center" action="#">
                                <button type="submit" class="btn text-white" style="font-size: 50px;">ENG_VOCAB 4</button>
                            </form>
                        </div>
                    </div>
                </div>
