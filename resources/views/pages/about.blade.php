...
@section('content')
    ...
    <section class="bannerPart">
        ...
        <div class="row">
            <div id="bannerTitle" class="text-center col-12">
                <h1 class="font-weight-bolder">ABOUT</h1>
            </div>
        </div>
    </section>
    ...
    <section class="contentPart" style="margin-top: 100px; margin-bottom: 100px;">
        <div class="contactPart" style="margin-bottom: 50px;">
            <div class="row">
                <div class="col-12">
                    <h1 id="partTextDark" class="font-weight-bolder text-white text-center">ABOUT US</h1>
                </div>
            </div>
            <div class="row" style="padding-left: 40px; padding-right: 40px;">
                <h3 id="partText" class="font-weight-bold">This is About</h3>
            </div>
        </div>
    </section>
